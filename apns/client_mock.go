...
type ClientMock struct {
	...
	funcSend          func(ctx context.Context, n *Notification) (err error)
	inspectFuncSend   func(ctx context.Context, n *Notification)
...
func (mmSend *mClientMockSend) Inspect(f func(ctx context.Context, n *Notification)) *mClientMockSend {
...
func (mmSend *ClientMock) Send(ctx context.Context, n *Notification) (err error) {
	...
	if mmSend.inspectFuncSend != nil {
		mmSend.inspectFuncSend(ctx, n)
	}

	mm_params := &ClientMockSendParams{ctx, n}
	...
	if mmSend.SendMock.defaultExpectation != nil {
		...
		mm_got := ClientMockSendParams{ctx, n}
	...
	if mmSend.funcSend != nil {
		return mmSend.funcSend(ctx, n)
	}
	mmSend.t.Fatalf("Unexpected call to ClientMock.Send. %v %v", ctx, n)
	return
}
